...
--
-- Name: games game_oppenent_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT game_oppenent_fk FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games game_winner_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT game_winner_fk FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
